...
public class ModuleExampleDetectorWorker extends PairwiseDetectorWorker<SimpleObjectEqualityRawResult<String>> {

	public ModuleExampleDetectorWorker(IDetector parent, ModelDataItem file1Data, ModelDataItem file2Data) {
